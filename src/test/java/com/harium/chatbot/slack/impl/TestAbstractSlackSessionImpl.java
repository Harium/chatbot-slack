...
import com.harium.chatbot.slack.events.SlackConnected;
import com.harium.chatbot.slack.listeners.SlackConnectedListener;
import com.harium.chatbot.slack.replies.*;
...
public class TestAbstractSlackSessionImpl
{
    ...
    public void testFindChannelByName_ExistingChannel()
    {
        ...
        Assertions.assertThat(slackSession.findChannelByName("testchannel1").getId()).isEqualTo("channelid1");
    }
    ...
    public void testFindChannelById_ExistingChannel()
    {
        ...
        Assertions.assertThat(slackSession.findChannelById("channelid1").getName()).isEqualTo("testchannel1");
    }
    ...
    public void testFindBotById_ExistingBot()
    {
        ...
        Assertions.assertThat(slackSession.findBotById("botid1").getUserName()).isEqualTo("botname1");
    }
    ...
    public void testFindUserById_ExistingBot()
    {
        ...
        Assertions.assertThat(slackSession.findUserById("userid1").getUserName()).isEqualTo("username1");
    }
    ...
    public void testFindUserByUserName_ExistingBot()
    {
        ...
        Assertions.assertThat(slackSession.findUserByUserName("username1").getId()).isEqualTo("userid1");
    }
